...
/* Core */
$string['configtitle'] = 'Wellness One';
$string['pluginname'] = 'Wellness One';
$string['choosereadme'] = '
<div class="clearfix">
<div class="well">
<h2>Wellness One</h2>
...
<div class="well">
<h3>About Wellness One</h3>
<p>Wellness One is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme, Essential.</p>
<h3>Parents</h3>
<p>This theme is based upon the Bootstrap and Essential themes, which was created for Moodle 2.5, with the help of:<br>
Stuart Lamour, Mark Aberdour, Paul Hibbitts, Mary Evans, Julian Ridden.</p>
</div></div>';
