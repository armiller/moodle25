...
$PAGE->set_url('/blocks/thelmsapp/newsletter_subscribe.php');
...
$subscriber_already_exists  = $DB->get_records_select('block_thelmsapp_newsletter', 'email =\'' . $email . '\'');
...
$lastinsertid        = $DB->insert_record('block_thelmsapp_newsletter', $subscriber, false);
